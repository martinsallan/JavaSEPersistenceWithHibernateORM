...
public class exibirFornecedor extends javax.swing.JFrame {
    ...
    private void controlarEstadoFormulario(boolean habilitado) {
        txtNomeFantasia.setEnabled(habilitado);
        txtTelefone.setEnabled(habilitado);
        ...
        btnAlterar.setEnabled(!habilitado && fornecedorSelecionado != null);

        btnDeletar.setEnabled(!habilitado || fornecedorSelecionado == null);
        btnBuscar.setEnabled(!habilitado || fornecedorSelecionado == null);
    }
    //</editor-fold>
